...
11. Waterfall projection invented default tiers, equity and multiples. It now requires explicit structured terms and project profit. Unsupported terms show an explanation instead of fabricated distributions. The supported simplified model is labeled illustrative.

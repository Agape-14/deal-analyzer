...
async def upload_document(
    ...
    unit_label = "sheet" if ext in SPREADSHEET_EXTS else "page"
    body_bits = [f"{page_count} {unit_label}{'s' if page_count != 1 else ''}"]
...
def _extract_uploaded_file(file_path: str, ext: str) -> tuple[dict, dict, str, int]:
    try:
        ...
        return (
            ...
            {"error": str(e), "document_kind": "spreadsheet" if ext in SPREADSHEET_EXTS else "pdf"},

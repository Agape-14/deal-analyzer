...
const buttonVariants = cva(
  // Base: tactile, medium-weight, spring-feeling scale on press
    ...
    "[&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground shadow-[0_1px_0_0_hsl(var(--primary)/.6)_inset,0_2px_8px_hsl(var(--primary)/.2)] hover:bg-primary/90",
        secondary:
